...
trainRowNumbers <- createDataPartition(fsd_processed$working, p=0.8, list=FALSE)
# Step 2: Create the training  dataset
trainData <- fsd_processed[trainRowNumbers,]
# Step 3: Create the test dataset
testData <- fsd_processed[-trainRowNumbers,]
